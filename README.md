...
[![GoDoc](https://godoc.org/github.com/agilab/golearn?status.png)](https://godoc.org/github.com/agilab/golearn)
[![Build Status](https://travis-ci.org/agilab/golearn.png?branch=master)](https://travis-ci.org/agilab/golearn)<br>

[![Support via Gittip](https://rawgithub.com/twolfson/gittip-badge/0.2.0/dist/gittip.png)](https://www.gittip.com/agilab/)
...
See [here](https://github.com/agilab/golearn/wiki/Installation) for installation instructions.
...
```bash
cd $GOPATH/src/github.com/agilab/golearn/examples/knnclassifier
go run knnclassifier_iris.go
```
```bash
cd $GOPATH/src/github.com/agilab/golearn/examples/instances
go run instances.go
```
```bash
cd $GOPATH/src/github.com/agilab/golearn/examples/trees
go run trees.go
```
 ...
 * [English](https://github.com/agilab/golearn/wiki)
